...
class CarlaLapEnv(gym.Env):
    ...
    def __init__(self, host="127.0.0.1", port=2000,
                 ...
                 synchronous=True, fps=0, action_smoothing=0.9,
                 start_carla=False):
        """
        ...
        try:
            ...
            self.world = World(self.client)
            #['/Game/Carla/Maps/Town01', '/Game/Carla/Maps/Town01_Opt', '/Game/Carla/Maps/Town02', '/Game/Carla/Maps/Town02_Opt', '/Game/Carla/Maps/Town03', '/Game/Carla/Maps/Town03_Opt', '/Game/Carla/Maps/Town04', '/Game/Carla/Maps/Town04_Opt', '/Game/Carla/Maps/Town05', '/Game/Carla/Maps/Town05_Opt']
    ...
    def step(self, action):
        ...
        if self.is_training:
            checkpoint_frequency = 5 # Checkpoint frequency in meters
...
def reward_fn(env):
    ...
    if early_termination:
        # If speed is less than 1.0 km/h after 5s, stop EDIT
        if time.time() - env.start_t > 6.0 and env.vehicle.get_speed() < 1.0 / 3.6:
            env.terminal_state = True

        # If distance from center > 3, stop EDIT
        if env.distance_from_center > 3.5:
            env.terminal_state = True
